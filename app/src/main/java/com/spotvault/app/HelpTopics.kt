...
val HelpTopics: List<Pair<String, List<HelpItem>>> = listOf(
    ...
    "Quick Pins" to listOf(
        ...
        HelpItem(Icons.Default.CameraAlt, "Auto-Attach Photo", "Have Quick Pin and/or Quick Track open the camera first and save with the photo attached, instead of saving silently with no photo — set separately for each in Quick-Pin Behavior settings.", settingsCategoryId = "quickpin")
    ),
    "The Vault" to listOf(
        ...
        HelpItem(Icons.Default.Archive, "Archive", "Hide a spot from the main Vault without deleting it — archived spots are kept forever, never shown in Auto Delete, and won't be touched by Clear All Vault Data. Archive a spot from its ⋮ menu, and view or restore archived spots from Settings → Vault → Archived Spots.", settingsCategoryId = "vault"),
    ...
    "Appearance & Themes" to listOf(
        ...
        HelpItem(Icons.Default.Edit, "Vault Name", "Rename your vault anything you like — it shows on the home screen, splash screen, and widgets.", settingsCategoryId = "appearance")
    ),
    ...
    "Widgets" to listOf(
        ...
        HelpItem(Icons.Default.Star, "Premium Dashboard widget", "Premium — a larger widget with your most recent Vault entries (tap to open), Snap/Pin/Share Photo shortcuts, Bluetooth Auto and Motion toggles, and a tracking mode with photo plus Found, Navigate, and Compass.", settingsCategoryId = "widgets"),
